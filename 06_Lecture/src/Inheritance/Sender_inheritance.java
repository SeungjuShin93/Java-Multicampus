package Inheritance;
public class Sender_inheritance {
	public static void main(String args[]) {
		 Account_update obj1 = new Account_update("111-22-333333", "ÀÓ²©Á¤", 10000); 
		 Account_checking obj2 = new Account_checking("444-55-666666", "È«±æµ¿", 20000, "5555-6666-7777-8888");
	 ...
	 static void printAccountInfo(Account_update obj) {
